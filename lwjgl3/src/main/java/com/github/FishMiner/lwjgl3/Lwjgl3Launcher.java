...
import com.github.FishMiner.data.stubs.FirebaseDesktopStub;
import com.github.FishMiner.data.stubs.LeaderboardDesktopStub;


/** Launches the desktop (LWJGL3) application. */
public class Lwjgl3Launcher {
    private static FirebaseInterface firebase;
    private static LeaderboardInterface leaderboard;

    public static void main(String[] args) {
        if (StartupHelper.startNewJvmIfRequired()) return; // This handles macOS support and helps on Windows.
        firebase = new FirebaseDesktopStub();
        leaderboard = new LeaderboardDesktopStub();
        createApplication();
    }

...
public class FullscreenService {
    ...
    public void resetFullscreen() {
        if (Gdx.graphics.setWindowedMode(FishMinerGame.WIDTH, FishMinerGame.HEIGHT)) {
            // Explicitly trying to resize the application listener to fully support all platforms:
            Gdx.app.getApplicationListener().resize(FishMinerGame.WIDTH, FishMinerGame.HEIGHT);
        }
    }
}
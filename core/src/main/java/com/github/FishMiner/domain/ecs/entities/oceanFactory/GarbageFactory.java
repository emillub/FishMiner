package com.github.FishMiner.domain.ecs.entities.oceanFactory;
...
public class GarbageFactory {
    ...
    private Entity createEntity(String texturePath, int frameCols, int frameRows, int depthLevel, int weight) {
        ...
        FishableComponent fishLike = engine.createComponent(FishableComponent.class); // reusing FishComponent

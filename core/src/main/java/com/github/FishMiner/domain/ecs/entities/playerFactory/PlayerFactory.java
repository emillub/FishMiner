...
import static com.github.FishMiner.domain.ecs.entities.ReelTypes.BASIC_REEL;
...
public class PlayerFactory {
    ...
    private static Entity createPlayerEntity(PooledEngine engine, int posX, int posY) {
        ...
        transformComponent.scale = new Vector2(Configuration.getInstance().getEntityScale(),

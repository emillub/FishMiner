...
import com.github.FishMiner.domain.ecs.entities.HookTypes;
import com.github.FishMiner.domain.ecs.entities.ReelTypes;
...
public class TraderFactory {
    ...
    private static Entity createTraderEntity(PooledEngine engine, int posX, int posY) {
        ...
        // animationComponent.addAnimation(TraderStates.NORMAL.getAnimationKey(),
        // textureComponent, 0, Animation.PlayMode.LOOP_RANDOM);
        // animationComponent.addAnimation(TraderStates.BUY.getAnimationKey(),
        // textureComponent, 1, Animation.PlayMode.LOOP_RANDOM);

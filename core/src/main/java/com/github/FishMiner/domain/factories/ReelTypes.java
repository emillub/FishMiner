...
public enum ReelTypes {
    ...
    LONG_REEL("Long_Reel.png", "Long Reel", 8, 1, 15.0f, 5, 100),
    FAST_REEL("FAST_REEL.png", "Fast Reel", 1, 1, 15.0f, 6, 200),
    LEGENDARY_REEL("LEGENDARY_REEL.png", "Lengendary Reel", 1, 1, 40.0f, 8, 400);

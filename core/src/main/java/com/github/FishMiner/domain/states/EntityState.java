...
//        SWINGING {
//            public void onEnter() {
//                System.out.println("Hook is swinging and ready to fire."); }
//
...
//
//            public void onEnter() {
//                GameEventBus.getInstance().post(new FireHookEvent(HookUtil.getHook(Configuration.getInstance().getEngine())));
//                System.out.println("Hook is fired towards the target.");
//            }
//
